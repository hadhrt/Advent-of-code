...
class Board2:
    ...
    grid_trans_new = {(0,">"):(1, ">"), (1,">"):(4, "<"), (2,">"):(1, "^"), (3,">"):(4, ">"), (4,">"):(1, "<"), (5,">"):(4, "^"),
                  (0,"<"):(3, ">"), (1,"<"):(0, "<"), (2,"<"):(3, "v"), (3,"<"):(0, ">"), (4,"<"):(3, "<"), (5,"<"):(0, "v"),
                  (0,"^"):(5, ">"), (1,"^"):(5, "^"), (2,"^"):(0, "^"), (3,"^"):(2, ">"), (4,"^"):(2, "^"), (5,"^"):(3, "^"),
                  (0,"v"):(2, "v"), (1,"v"):(2, "<"), (2,"v"):(4, "v"), (3,"v"):(5, "v"), (4,"v"):(5, "<"), (5,"v"):(1, "v")}
    #                             -----new row-----       -----new col-----
    grid_trans={(0,">"):(1 , ">", lambda row,col: row,    lambda row,col: 0),
                (0,"<"):(3 , ">", lambda row,col: 49-row, lambda row,col: 0),
                (0,"^"):(5 , ">", lambda row,col: col,    lambda row,col: 0),
                (0,"v"):(2 , "v", lambda row,col: 0,      lambda row,col: col),
                
                (1,">"):(4 , "<", lambda row,col: 49-row, lambda row,col: 49),
                (1,"<"):(0 , "<", lambda row,col: row,    lambda row,col: 49),
                (1,"^"):(5 , "^", lambda row,col: 49,     lambda row,col: col),
                (1,"v"):(2 , "<", lambda row,col: col,    lambda row,col: 49),
                
                (2,">"):(1 , "^", lambda row,col: 49,     lambda row,col: row),
                (2,"<"):(3 , "v", lambda row,col: 0,      lambda row,col: row),
                (2,"^"):(0 , "^", lambda row,col: 49,     lambda row,col: col),
                (2,"v"):(4 , "v", lambda row,col: 0,      lambda row,col: col), 
                
                (3,">"):(4 , ">", lambda row,col: row,    lambda row,col: 0),
                (3,"<"):(0 , ">", lambda row,col: 49-row, lambda row,col: 0),
                (3,"^"):(2 , ">", lambda row,col: col,    lambda row,col: 0),
                (3,"v"):(5 , "v", lambda row,col: 0,      lambda row,col: col),     

                (4,">"):(1 , "<", lambda row,col: 49-row, lambda row,col: 49),
                (4,"<"):(3 , "<", lambda row,col: row,    lambda row,col: 49),
                (4,"^"):(2 , "^", lambda row,col: 49,     lambda row,col: col),
                (4,"v"):(5 , "<", lambda row,col: col,    lambda row,col: 49),

                (5,">"):(4 , "^", lambda row,col: 49,     lambda row,col: row),
                (5,"<"):(0 , "v", lambda row,col: 0,      lambda row,col: row),
                (5,"^"):(3 , "^", lambda row,col: 49,     lambda row,col: col),
                (5,"v"):(1 , "v", lambda row,col: 0,      lambda row,col: col),                
    }
    ...
    def move_player_to_new_grid(self):
        ...
        player_grid = self.grids[new_state[0]]
        player_pos = ( new_state[2](*self.player_pos), new_state[3](*self.player_pos))
        # if player would hit a wall, dont execute grid change
        if player_grid.get(player_pos) == "#":
            return False
            
        self.player_grid = player_grid
        self.player_pos = player_pos
        self.player_dir = new_state[1]
    ...
    def move_player_to_new_grid_new(self):
        new_state = self.grid_trans_new[(self.grids.index(self.player_grid),self.player_dir)]
    ...
    def move_player_one_step(self):
        ...
        match self.player_grid.get(new_pos,"oob"):
            ...
            case "#":
                return False
            case "oob":
                return self.move_player_to_new_grid_new()
            case _:
                assert(False)    
